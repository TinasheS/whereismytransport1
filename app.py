...
if __name__ == "__main__":
    source_dir = r"C:\Users\t.shokoni\Desktop\files\2017-08-30" # path-to-folder-with-logs-you-wish-to-summarize
    destination_dir = r"C:\Users\t.shokoni\Desktop\files\json" # path-to-folder-you-wish-to-save-json-summaries
